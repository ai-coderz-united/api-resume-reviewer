...
async def resume_review(file: UploadFile, job_title: str, company_name: str):
	try:
		pdf_resume = PDFResume(resume=file, desired_job_title=job_title, desired_company=company_name)
		...
		resume_recommendations = resume_review.resume_recommendations(jsonified_resume, job_title, company_name)
